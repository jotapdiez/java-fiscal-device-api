...
public interface HasarConstants
{
	...
	/** Cambiar velocidad de comunicaci�n. (0xA0) */
	...
	/** Imprimir reporte de auditor�a por fecha. (0x3A) */
	public int CMD_DAILY_CLOSE_BY_DATE        = 0x3A;
	/** Imprimir reporte de auditor�a por n�mero de Z. (0x3B) */
	...
	/** Iniciar consulta de la informaci�n de IVA. (0x70) */
	public int CMD_GET_FIRST_IVA_DATA         = 0x70;
	/** Continuar consulta de la informaci�n de IVA. (0x71) */
	public int CMD_GET_NEXT_IVA_DATA          = 0x71;
	/** TODO: (0x2C) */
	public int CMD_GET_LAST_EXECUTION_ERROR   = 0x2C;
	/** TODO: (0xAA) */
	public int CMD_GET_FIRST_LOG_BLOCK        = 0xAA;
	/** TODO: (0xAB) */
	public int CMD_GET_NEXT_LOG_BLOCK         = 0xAB;
	/** TODO: (0xA6) */
	public int CMD_GET_AUDIT_FIRST_BLOCK      = 0xA6;
	/** TODO: (0xA7) */
	public int CMD_GET_AUDIT_NEXT_BLOCK       = 0xA7;
	/** TODO: (0xB5) */
	public int CMD_GET_DEFINE_ERASABLE_Z_RANGE= 0xB5;
	/** TODO: (0xB6) */
	public int CMD_GET_ERASABLE_Z_RANGE       = 0xB6;
	/** TODO: (0xA9) */
	public int CMD_GET_DOCUMENT_FIRST_BLOCK       = 0xA9;
	...
	/** DF: Definir l�neas de texto en recibos. (0x97) */
	...
	/** DNFH: Imprimir �tem en remito u orden de salida. (0x82) */
	public int CMD_PRINT_EMBARK_ITEM          = 0x82;
	/** DNFH: Imprimir �tem en resumen de cuenta o en cargo a la habitaci�n. (0x83) */
	public int CMD_PRINT_ACCOUNT_ITEM         = 0x83;
	/** DNFH: Imprimir �tem en cotizaci�n. (0x84) */
	...
	// Tambi�n puede se�alar impresora ocupada en impresoras para Chile.
	public int PST_PRINTER_ERROR              = 0x0004;

	/** Impresora fuera de l�nea. No ha podido comunicarse con la impresora dentro del per�odo de tiempo establecido. (Bit 3 del estado de impresora) */
	...
	/** Buffer de impresi�n lleno. Cualquier comando que se env�e cuando este bit est� en 1 no se ejecuta y debe ser reenviado por la aplicaci�n. (Bit 6 del estado de impresora) */
	public int PST_PRINT_BUFFER_FULL          = 0x0040;

	/** Buffer de impresi�n vac�o. Todos los comandos fueron enviados a la impresora. (Bit 7 del estado de impresora) */
	...
	/** Caj�n de dinero cerrado o ausente. (Bit 14 del estado de impresora) */
	public int PST_MONEY_DRAWER_CLOSED        = 0x4000;

	/** Suma l�gica (OR) de los bits 2 a 5, 8 y 14. Este bit se encuentra en 1 siempre que alguno de los bits mencionados se encuentre en 1. (Bit 15 del estado de impresora) */
	public int PST_BITWISE_OR                 = 0x8000;


	//// ESTADO FISCAL ///////////////////////

	/** Error en chequeo de memoria fiscal. Al encenderse la impresora se produjo un error en el checksum. La impresora no funcionar�. (Bit 0 de estado fiscal) */
	public int FST_FISCAL_MEMORY_CRC_ERROR    = 0x0001;

	/** Error en chequeo de memoria de trabajo. Al encenderse la impresora se produjo un error en el checksum. La impresora no funcionar�. (Bit 1 de estado fiscal) */
	...
	/** Datos inv�lidos en un campo. Uno de los campos del comando recibido tiene datos no v�lidos (por ejemplo, datos no num�ricos en un campo num�rico). (Bit 4 de estado fiscal) */
	public int FST_INVALID_DATA_FIELD         = 0x0010;

	/** Comando inv�lido para el estado fiscal actual. Se ha recibido un comando que no es v�lido en el estado actual del controlador (por ejemplo, abrir un documento no fiscal cuando se encuentra abierto un documento fiscal). (Bit 5 de estado fiscal) */
	public int FST_INVALID_COMMAND            = 0x0020;

	/** Desborde de acumulador. El acumulador de una transacci�n, del total diario o del IVA se desbordar� a ra�z de un comando recibido. El comando no es ejecutado. Este bit debe ser monitoreado por la aplicaci�n para emitir el correspondiente aviso. (Bit 6 de estado fiscal) */
	...
	/** Memoria fiscal a punto de llenarse. La memoria fiscal tiene 30 o menos registros libres. Este bit debe ser monitoreado por la aplicaci�n para emitir el correspondiente aviso. (Bit 8 de estado fiscal) */
	...
	/** Error en ingreso de fecha. Se ha ingresado una fecha inv�lida. Para volver el bit a 0 debe ingresarse una fecha v�lida. (Bit 11 de estado fiscal) */
	public int FST_CLOCK_ERROR                = 0x0800;

	/** Documento fiscal abierto. Este bit se encuentra en 1 siempre que un documento fiscal (factura, recibo oficial o nota de cr�dito) se encuentra abierto. (Bit 12 de estado fiscal) */
	...
	/** Suma l�gica (OR) de los bits 0 a 8. Este bit se encuentra en 1 siempre que alguno de los bits mencionados se encuentre en 1. (Bit 15 de estado fiscal) */
